...
export function Navbar() {
  ...
  return (
    <>
      {/* Desktop Navbar - Top */}
      <nav className="hidden md:block bg-black text-yellow-400 p-4 shadow-lg sticky top-0 z-50">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-black text-yellow-400 p-3 shadow-lg z-50 border-t border-yellow-400">
        <div className="flex items-center justify-between max-w-sm mx-auto">
          {/* Left Side */}
          <div className="flex items-center space-x-3">
            <Link href="/" className="flex flex-col items-center space-y-1 hover:text-yellow-300 transition-colors p-2">
